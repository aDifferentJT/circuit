...
wires : Producing input output -> SortedSet (Wire input output)
wires {input} {output} = snd . snd . flip runState (empty, empty) . wires'' {input} {a = output} OutputTerminus . collate
