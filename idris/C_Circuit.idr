...
toCPoly {extra} (a & b)       (x, y)        = \i => case i of
                                                         0 =>
                                                             let smaller = xSmallerThanMaxNatXY (countIndices a) (countIndices b) in
                                                                 let padding = maxNat (countIndices a) (countIndices b) - countIndices a in
                                                                     rewrite sym $ plusMinusCancel (maxNat (countIndices a) (countIndices b)) (countIndices a) in
                                                         ...
                                                         1 =>
                                                             let smaller = ySmallerThanMaxNatXY (countIndices a) (countIndices b) in
                                                                 let padding = maxNat (countIndices a) (countIndices b) - countIndices b in
                                                                     rewrite sym $ plusMinusCancel (maxNat (countIndices a) (countIndices b)) (countIndices b) in
                                                                             rewrite sym (plusAssociative (countIndices b) padding extra) in
                                                                                     toCPoly {extra=padding + extra} b y
                                                         _ => constN (the Int (-1))
toCPoly {extra} (EncVect n a) xs            = \i =>
             maybe
             (constN (the Int (-1)))
             (toCPoly {extra} a)
             (flip index xs <$> integerToFin (cast i) n)
